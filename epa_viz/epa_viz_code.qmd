---
title: "NFL Expected Points Added Model - Visualization"
format: html
editor: visual
---

I'll use an established model predicting the expected points given the specific circumstances of a play before in starts. Those circumstances were linked to historical data on what the next score (e.g. possessing team TD, opposing team FG, end of half) ended up being, with the expected points essentially being the sum of the points from each possible outcome multiplied by the estimated probability of it happening. It was made available by the prolific and tireless producers of the [nflverse](https://nflverse.nflverse.com/) R package. As support, they've provided ample [documentation](https://www.opensourcefootball.com/posts/2020-09-28-nflfastr-ep-wp-and-cp-models/), and even a handy function to quickly output the expected points given all the terms. I also think that [NFELO](https://www.nfeloapp.com/analysis/expected-points-added-epa-nfl/) provides a nice overview of how it's used, so you can check them out.
...
#code extracted from blog post 7/5/23
